...
2::::::::::::::::::2   00:::::::::00           4::::::::4   88:::::::::88   
22222222222222222222     000000000             4444444444     888888888 """.center(columns))
...
def print_tab():
    ...
    print("\n" * 3)
    for i in range(4):
        print("                      \033[1;32;33m  %4d    %4d    %4d    %4d   \033[0m" % (
...
def goal():
    ...
    print("\n")
    userinput = input(
        "\033[1;32;45m Press any letter to return to Start Menu or 'x' to exit!  \033[0m")
    if userinput == 'x':
        exit()
    else:
        start_menu()
...
""")
    ...
    userinput = input(
        "Press '1' to return to Start Menü, or any button to exit!")
    if userinput == "1":
        start_menu()
    else:
        exit()
...
def main():
    ...
    while True:
        move = input(
            "Please enter direction!(or 'x' to return to Start Menu):  ")
        os.system('cls' if os.name == 'nt' else 'clear')
